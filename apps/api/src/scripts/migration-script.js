  ...
  const cards = await prisma.card.createMany({
    data: [
      ...
      // },
      {
        ...
        foilPattern: "rareHolo",
        cardMarketLink:
          "https://www.cardmarket.com/en/Pokemon/Products/Singles/M-P-Promos/Celebratory-Fanfare-M-P033",
        psaLink:
          "https://www.psacard.com/pop/tcg-cards/2025/pokemon-japanese-m-p-promo/312898",
