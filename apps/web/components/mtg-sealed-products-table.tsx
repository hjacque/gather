...
export function MtgSealedProductsTable({
  dataPromise,
  type,
  set,
  block,
        ...
        type || set || block
          ? (data, table) => {
              ...
              const allBlocks = [
                ...new Set(
                  data
                    .filter((i) => !!i.productSet.block)
                    .map((i) => i.productSet.block!),
                ),
              ].sort();
              return (
