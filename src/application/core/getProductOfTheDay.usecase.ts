import { Set, Franchise, ProductEntity, ProductType } from "../../entities/product.entity";
...
export class GetProductOfTheDayUsecase {
  ...
  async execute(dto: GetProductOfTheDayUsecaseInputDto): Promise<
  ...
  > {
    ...
    const topPerformance =
      await this.performanceRepository.getTopPerformance(today, dto.franchise, dto.type);
